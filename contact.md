...
<div style="display: flex; flex-wrap: wrap; gap: 40px; margin-top: 30px; align-items: flex-start; font-family: inherit;">
  ...
  <div style="flex: 2; min-width: 300px;">
    <div style="margin-bottom: 20px;">
      <div style="margin-bottom: 5px; font-size: 1.5em; font-family: inherit;">Prof. Kuanming Yao</div>
      
      <p style="margin-top: 0; line-height: 1.6; font-style: normal; font-family: inherit;">
